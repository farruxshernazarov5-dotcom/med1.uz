...
2.5. Platformadan foydalanish uchun minimal yosh — 18 yosh. 18 yoshga to'lmagan shaxslar Platformadan faqat qonuniy vakili (ota-ona, vasiy, homiy) roziligi va nazorati ostida, uning hisobi orqali foydalanishi mumkin.

2.6. Muomalaga layoqatsiz yoki muomala layoqati cheklangan shaxslar nomidan Platformadan qonuniy vakil foydalanadi va barcha huquqiy oqibatlar uchun javob beradi.

2.7. Foydalanuvchi Platformadan O'zbekiston Respublikasi hududidan tashqarida foydalansa, o'z yurisdiksiyasi qonunchiligiga rioya qilish majburiyatini o'z zimmasiga oladi.

2.8. Shartnomaning bir qismi sud yoki vakolatli organ tomonidan haqiqiy emas deb topilsa, qolgan qismlar o'z kuchini saqlaydi (severability).
...
4.1.2. Katalogdagi ma'lumotlar Klinika/Shifokor tomonidan taqdim etiladi. Operator ularning to'liqligi va dolzarbligi uchun javobgar emas, biroq aniq xatolik haqida xabar olganda oqilona muddatda tekshiruv o'tkazadi.
...
4.2.2. Yozuv tasdiqlangani, o'zgargani yoki bekor qilingani haqida Bemorga bildirishnoma yuboriladi.

4.2.3. Bemor qabuldan kamida 3 (uch) soat oldin yozuvni bepul bekor qilishi mumkin, agar Klinika boshqacha (yumshoqroq) shart belgilamagan bo'lsa. Kechiktirib bekor qilish yoki kelmaslik (no-show) Klinika qoidalariga muvofiq oldindan to'lovni yo'qotishga olib kelishi mumkin.

4.2.4. Klinika/Shifokor obyektiv sabablarga ko'ra (kasallik, favqulodda holat, jadval o'zgarishi) yozuvni bekor qilishi mumkin; bunda oldindan to'lov to'liq qaytariladi yoki boshqa vaqtga ko'chiriladi.
...
4.3.2. Teletibbiyot seansi boshlanishidan oldin Bemor alohida axborotlangan rozilik (informed consent) beradi. Rozilik bermaslik seansdan voz kechish deb hisoblanadi.

4.3.3. Konsultatsiya davomida yuzaga kelishi mumkin bo'lgan texnik uzilishlar (internet tezligi, qurilma nosozligi) uchun Operator faqat o'z serverlari nosozligi doirasida javob beradi.

4.3.4. Seansni yozib olish faqat har ikkala tomonning oldindan roziligi bilan amalga oshiriladi. Yozuvni ruxsatsiz tarqatish qonunbuzarlik hisoblanadi va javobgarlikka sabab bo'ladi.

4.3.5. Teletibbiyot orqali quyidagilar TAQIQLANADI: shoshilinch va reanimatsion holatlarni boshqarish; qonunchilik bilan cheklangan (giyohvandlik, psixotrop) preparatlarni tayinlash; birinchi marta og'ir ruhiy kasalliklarni tashxislash; huquqiy ahamiyatga ega ekspertiza xulosalarini berish.
...
4.4.2. AI natijalari FAQAT AXBOROT XARAKTERIGA EGA. Ular tibbiy tashxis, retsept, klinik qaror yoki shifokor xulosasi HISOBLANMAYDI va ularni almashtirmaydi.

4.4.3. AI modellari xato qilishi, noto'liq yoki noto'g'ri natija berishi («gallyutsinatsiya») mumkin. Foydalanuvchi har qanday AI natijasini malakali shifokor bilan tasdiqlashi shart.

4.4.4. AI modullarida uchinchi tomon provayderlarining texnologiyalari qo'llanilishi mumkin. Bunda so'rov matni depersonalizatsiya qilingan holda qayta ishlanishi mumkin; Foydalanuvchi bunga rozilik beradi.

4.4.5. AI-ga shaxsni identifikatsiya qiluvchi ortiqcha ma'lumot (pasport raqami, to'liq manzil, bank kartasi) kiritish TAQIQLANADI.
...
4.5.2. EMR yozuvlarining tibbiy mazmuni uchun uni kiritgan Shifokor/Klinika javobgar. Operator saqlash, shifrlash, zaxiralash va kirishni cheklash uchun javobgar.

4.5.3. Bemor o'z EMR yozuvlariga kirish, nusxa olish, eksport qilish (PDF/JSON) huquqiga ega.

4.5.4. Shifokor Bemor yozuvlariga faqat Bemor roziligi asosida yoki faol qabul/konsultatsiya doirasida kirish huquqiga ega bo'ladi. Rozilik istalgan vaqtda qaytarib olinishi mumkin.

4.5.5. Har bir kirish audit jurnalida (kim, qachon, qaysi yozuvni ko'rdi) qayd etiladi. Bemor audit jurnalini so'rash huquqiga ega.
...
4.6.2. Operator retsept mazmuniga aralashmaydi va uni tibbiy jihatdan tekshirmaydi.

4.6.3. Dori vositalari ma'lumotnomasi ma'lumotlari ochiq manbalar va ishlab chiqaruvchi hujjatlariga asoslanadi va o'z-o'zini davolash uchun asos bo'la olmaydi.
...
4.7.2. Tahlil natijalarining aniqligi, biomaterialni olish va tashish sifati uchun laboratoriya javobgar.
...
4.9.2. Med-Coin PUL EMAS, to'lov vositasi emas, elektron pul emas va kriptoaktiv emas. U naqdlashtirilmaydi, boshqa shaxsga o'tkazilmaydi (agar Operator alohida ruxsat bermasa) va meros qilinmaydi.

4.9.3. Med-Coin faqat Platforma ichidagi chegirma, aksiya yoki xizmat qiymatining bir qismini qoplash uchun ishlatilishi mumkin.

4.9.4. Med-Coin amal qilish muddati Tariflar/Aksiya qoidalarida belgilanadi. Muddat o'tgach ballar kuydiriladi.
...
4.10.2. Klinika o'z xodimlariga rollar (administrator, registrator, shifokor, hamshira, buxgalter) belgilaydi va ular harakati uchun javobgar bo'ladi.

4.10.3. Klinika o'z bemorlari ma'lumotlarini qayta ishlashda mustaqil operator sifatida, Platforma esa qayta ishlovchi (processor) sifatida ish yuritadi; tegishli tartib alohida Ma'lumotlarni qayta ishlash kelishuvida (DPA) belgilanishi mumkin.
...
4.11.2. API dan foydalanish alohida API Terms hujjati, limitlar (rate limit) va xavfsizlik talablariga bo'ysunadi.

4.11.3. API kalitini oshkor qilish, qayta sotish, teskari injiniring qilish yoki limitlarni chetlab o'tish taqiqlanadi.
...
4.14.2. Taqiqlanadi: haqorat, tuhmat, uchinchi shaxs shaxsiy ma'lumotlari, reklama, raqobatchini obro'sizlantirish, soxta va buyurtma sharhlar.

4.14.3. Operator sharhni moderatsiya qilish, qisman yashirish yoki o'chirish huquqiga ega. Shifokor/Klinika sharhga ochiq javob berish huquqiga ega.
...
5.2. Foydalanuvchi haqiqiy, to'liq va dolzarb ma'lumot kiritishi shart. Soxta ma'lumot kiritish hisobni bloklashga asos bo'ladi.

5.3. Shifokor va Klinikalar qo'shimcha verifikatsiyadan o'tadi: diplom, litsenziya, sertifikat, guvohnoma, STIR/JSHSHIR, ish joyi to'g'risidagi hujjatlar taqdim etiladi. Operator hujjatlarning haqiqiyligini tekshirishga haqli, biroq bunday tekshiruv Operator zimmasiga tibbiy sifat kafolatini yuklamaydi.

5.4. Verifikatsiya belgisi («tasdiqlangan profil») faqat hujjatlar taqdim etilganini bildiradi va tibbiy natija kafolati emas.

5.5. Foydalanuvchi hisobga kirish ma'lumotlari (login, parol, OTP kodi) maxfiyligini ta'minlashi shart. Ushbu ma'lumotlar orqali sodir etilgan barcha harakatlar Foydalanuvchi tomonidan sodir etilgan deb hisoblanadi.

5.6. Hisobga ruxsatsiz kirish aniqlansa, Foydalanuvchi zudlik bilan Operatorni info@med1.uz orqali xabardor qilishi shart.

5.7. Bir shaxsga bir nechta hisob ochish, boshqa shaxs nomidan ro'yxatdan o'tish yoki hisobni sotish/ijaraga berish taqiqlanadi.

5.8. Operator xavfsizlik maqsadida qo'shimcha identifikatsiya (ikki bosqichli autentifikatsiya, hujjat surati, selfi-verifikatsiya, MyID/OneID integratsiyasi) talab qilishi mumkin.

5.9. 12 (o'n ikki) oy davomida faol bo'lmagan hisob nofaol deb topilishi va oldindan xabardor qilingan holda arxivlanishi mumkin.
...
8.2. Operator narxlarni bir tomonlama o'zgartirishga haqli. Yangi narx e'lon qilingan paytdan boshlab yangi buyurtmalarga nisbatan qo'llaniladi va allaqachon to'langan xizmatlarga ta'sir qilmaydi.

8.3. To'lov usullari: bank kartalari (UZCARD, HUMO, VISA, Mastercard), mobil to'lov tizimlari, bank o'tkazmasi, Platforma hisobidagi mablag' (depozit), Med-Coin bilan qisman qoplash.

8.4. To'lov Operator hisobvarag'iga yoki to'lov agenti hisobiga mablag' tushgan paytdan bajarilgan hisoblanadi.
...
8.8. Hisobot davri oxirida tomonlar bajarilgan ishlar dalolatnomasini (akt) elektron shaklda imzolaydilar. Agar hamkor 5 (besh) ish kuni ichida asoslantirilgan e'tiroz bildirmasa, akt imzolangan hisoblanadi.

8.9. Barcha to'lov hujjatlari (chek, hisobvaraq-faktura, akt) elektron shaklda shaxsiy kabinetda shakllantiriladi va yuridik kuchga ega.

8.10. To'lov muddati o'tkazib yuborilganda Operator har bir kechiktirilgan kun uchun qarz summasining 0,1 (nol butun o'ndan bir) foizi miqdorida penya undirishga, lekin umumiy qarz summasidan oshmagan holda haqli.

8.11. Foydalanuvchi to'lovni uchinchi shaxs kartasi orqali amalga oshirganda, karta egasining roziligini olganini kafolatlaydi.
...
9.5. Qaytarish so'rovi shaxsiy kabinet yoki info@med1.uz orqali yuboriladi va 3 (uch) ish kunida ko'rib chiqiladi. Ijobiy qaror qabul qilinsa, mablag' 10 (o'n) ish kuni ichida to'lov amalga oshirilgan usulda qaytariladi (bank muddatlari hisobga olinmagan holda).
...
10.2. Foydalanuvchi Shartnomani aksept qilish orqali quyidagi ma'lumotlar qayta ishlanishiga rozilik beradi: identifikatsiya ma'lumotlari (F.I.Sh., tug'ilgan sana, jinsi, hujjat ma'lumotlari), aloqa ma'lumotlari (telefon, email, manzil), akkaunt ma'lumotlari, to'lov ma'lumotlari (maskalangan), texnik ma'lumotlar (IP, qurilma, brauzer, cookie, geolokatsiya), foydalanish ma'lumotlari, hamda SOG'LIQ TO'G'RISIDAGI MAXSUS TOIFADAGI MA'LUMOTLAR.

10.3. Sog'liq to'g'risidagi ma'lumotlar faqat alohida, aniq ifodalangan rozilik asosida qayta ishlanadi. Rozilik istalgan vaqtda qaytarib olinishi mumkin; bu rozilik amalda bo'lgan davrda amalga oshirilgan qayta ishlashning qonuniyligiga ta'sir qilmaydi.

10.4. Qayta ishlash maqsadlari: shartnomani bajarish, xizmat ko'rsatish, identifikatsiya, to'lovlarni amalga oshirish, xavfsizlikni ta'minlash, sifatni oshirish, qonuniy talablarni bajarish, Foydalanuvchi roziligi bilan marketing.

10.5. Ma'lumotlar O'zbekiston Respublikasi hududidagi serverlarda saqlanadi. Chegaralararo uzatish faqat qonunchilikda nazarda tutilgan hollarda va tegishli himoya darajasi ta'minlangan holda amalga oshiriladi.

10.6. Operator quyidagi himoya choralarini qo'llaydi: kanal shifrlash (TLS), saqlashda shifrlash, rolga asoslangan kirish nazorati (RBAC), ikki bosqichli autentifikatsiya, audit jurnallari, zaxira nusxalash, xodimlar bilan maxfiylik majburiyatlari.

10.7. Tibbiy sir «Aholi salomatligini saqlash to'g'risida»gi Qonunga muvofiq himoya qilinadi. Uni oshkor qilish faqat Bemor roziligi yoki qonunda ko'rsatilgan hollarda mumkin.

10.8. Foydalanuvchining huquqlari: ma'lumotlariga kirish, to'g'rilash, o'chirish, cheklash, ko'chirish (portability), rozilikni qaytarib olish, avtomatlashtirilgan qarorga e'tiroz bildirish, vakolatli organga shikoyat qilish.

10.9. Ma'lumotlar xavfsizligi buzilishi (data breach) aniqlansa, Operator qonunda belgilangan muddatda vakolatli organni va ta'sirlangan foydalanuvchilarni xabardor qiladi.
...
11.6. Mualliflik huquqi buzilganligi to'g'risidagi murojaat info@med1.uz manziliga huquq egasi ma'lumotlari, obyekt tavsifi va huquqni tasdiqlovchi hujjat bilan yuboriladi; Operator 10 ish kuni ichida ko'rib chiqadi.
...
12.5. Shoshilinch holatlar (yurak xurujiga shubha, insult belgilari, og'ir qon ketish, nafas olishning buzilishi, hushdan ketish, o'z joniga qasd qilish fikri, og'ir jarohat, zaharlanish, anafilaksiya) — Platformadan foydalanmang, darhol 103 ga qo'ng'iroq qiling.

12.6. Platforma retseptli dori tayinlash, kasallik varaqasi (bolnichniy) berish, harbiy/haydovchilik komissiyasi xulosasi berish uchun mo'ljallanmagan, agar qonunchilik va tegishli litsenziya buni alohida nazarda tutmagan bo'lsa.
...
13.3. Rejalashtirilgan texnik ishlar imkon qadar tungi soatlarda o'tkaziladi va kamida 24 soat oldin e'lon qilinadi.

13.4. Texnik yordam kanallari: info@med1.uz, +998 99 214 41 03, shaxsiy kabinetdagi chat, Platformadagi murojaat shakli. Ish vaqti: dushanba–shanba, 09:00–18:00 (UTC+5), shoshilinch texnik hodisalar bundan mustasno.

13.5. Murojaatlarga javob berish maqsadli muddatlari: kritik (tizim ishlamayapti) — 4 soat; yuqori — 1 ish kuni; o'rta — 3 ish kuni; past — 5 ish kuni.
...
14.2. Operator qonunchilikda ruxsat etilgan maksimal darajada quyidagi kafolatlarni rad etadi: Platformaning uzluksiz va xatosiz ishlashi; Foydalanuvchining muayyan maqsadiga mosligi; uchinchi tomon kontentining to'g'riligi; muayyan tibbiy yoki tijorat natijaga erishilishi.

14.3. Platformadagi uchinchi tomon havolalari (linklar) Operator nazoratida emas va ular mazmuni uchun Operator javobgar emas.
...
15.3. Operator quyidagilar uchun javobgar emas: boy berilgan foyda; bilvosita, tasodifiy yoki oqibatli zarar; ma'lumot yo'qolishi (agar Operator aybi bo'lmasa); obro'ga yetkazilgan zarar; uchinchi shaxslar harakati.

15.4. Foydalanuvchi Shartnomani buzishi natijasida Operatorga yetkazilgan real zararni to'liq hajmda qoplaydi.

15.5. Foydalanuvchi Operatorni uchinchi shaxslarning uning harakatlari (kontent joylashtirish, huquqbuzarlik, ma'lumotlarni noqonuniy kiritish) natijasida yuzaga kelgan da'volaridan xoli qiladi va sud xarajatlarini qoplaydi (indemnification).
...
16.2. Fors-major holatlariga kiradi: tabiiy ofatlar, zilzila, suv toshqini, yong'in, epidemiya va pandemiya, karantin, harbiy harakatlar, terrorchilik akti, ommaviy tartibsizliklar, davlat organlarining Shartnoma bajarilishini imkonsiz qiluvchi hujjatlari, magistral internet yoki elektr ta'minotining uzoq muddatli uzilishi, keng miqyosli kiberhujumlar.

16.3. Fors-major holati yuzaga kelgan tomon 10 (o'n) kun ichida ikkinchi tomonni xabardor qilishi shart.
...
17.2. Muhim o'zgarishlar (narx, javobgarlik, ma'lumotlar qayta ishlash doirasi) haqida Foydalanuvchi kamida 10 (o'n) kun oldin elektron pochta yoki bildirishnoma orqali xabardor qilinadi.

17.3. O'zgarishlar kuchga kirgandan so'ng Platformadan foydalanishni davom ettirish — yangi tahrirni qabul qilish deb hisoblanadi.

17.4. Foydalanuvchi istalgan vaqtda hisobini o'chirish orqali Shartnomani bekor qilishi mumkin. Bu yuzaga kelgan qarzdorlikni to'lash majburiyatini bekor qilmaydi.

17.5. Operator Shartnomani bir tomonlama bekor qilishi mumkin, agar: Foydalanuvchi Shartnomani jiddiy buzsa; soxta ma'lumot taqdim etsa; firibgarlik alomatlari aniqlansa; qonunbuzarlik sodir etsa; 12 oydan ortiq faol bo'lmasa.

17.6. Shartnoma bekor qilinganda 10-, 11-, 15-, 18- va 19-bo'limlar o'z kuchini saqlab qoladi.
...
18.2. Da'vo (pretenziya) tartibi majburiy. Da'vo yozma shaklda info@med1.uz manziliga yoki pochta orqali yuboriladi va quyidagilarni o'z ichiga olishi kerak: murojaat qiluvchi ma'lumotlari, holat bayoni, talab, asoslovchi hujjatlar.

18.3. Da'vo 15 (o'n besh) kalendar kun ichida ko'rib chiqiladi va yozma javob beriladi.

18.4. Kelishuvga erishilmasa, nizo O'zbekiston Respublikasi qonunchiligiga muvofiq sudda ko'rib chiqiladi. Yuridik shaxslar bilan nizolar Operatorning joylashgan yeri bo'yicha iqtisodiy sudda, iste'molchilar bilan nizolar esa qonunchilikda belgilangan sudda ko'riladi.

18.5. Qo'llaniladigan huquq — O'zbekiston Respublikasi moddiy huquqi.
...
19.3. Foydalanuvchi aloqa ma'lumotlari o'zgarganda 5 (besh) kun ichida ularni yangilashi shart. Aks holda eski manzilga yuborilgan xabarnoma lozim darajada yuborilgan hisoblanadi.
...
20.3. Ilova qurilmaning quyidagi funksiyalariga kirish so'rashi mumkin: kamera (hujjat/tibbiy tasvir yuklash), mikrofon (audio/video konsultatsiya), geolokatsiya (yaqin klinikalarni topish), bildirishnomalar, xotira (fayl yuklash), sog'liq ma'lumotlari (agar Foydalanuvchi ulasa). Har bir ruxsat alohida so'raladi va istalgan vaqtda bekor qilinishi mumkin.

20.4. Ruxsatni bekor qilish tegishli funksiyaning ishlamasligiga olib keladi; bu Operator aybi hisoblanmaydi.

20.5. Operator eskirgan ilova versiyalarini qo'llab-quvvatlashni to'xtatishga haqli. Xavfsizlik yangilanishlarini o'rnatmaslik oqibatlari Foydalanuvchi zimmasida.

20.6. Uchinchi tomon do'koni orqali amalga oshirilgan to'lovlar bo'yicha qaytarish tartibi tegishli do'kon qoidalari bilan tartibga solinadi.
...
21.3. Geolokatsiya ma'lumotlari faqat qurilma sozlamalarida ruxsat berilganda va yaqin atrofdagi muassasalarni ko'rsatish, shoshilinch yordamni yo'naltirish maqsadida qayta ishlanadi.

21.4. Operator veb-analitika va nosozliklarni kuzatish (crash analytics) vositalaridan foydalanishi mumkin. Bunday ma'lumotlar imkon qadar depersonalizatsiya qilinadi.

21.5. Platformada ayrim qarorlar avtomatlashtirilgan tarzda qabul qilinishi mumkin: firibgarlikka qarshi filtr, spam-sharh aniqlash, navbat taqsimlash, tavsiya algoritmi, kredit/limit belgilash.

21.6. Foydalanuvchi avtomatlashtirilgan qaror bo'yicha inson tomonidan qayta ko'rib chiqilishini talab qilish huquqiga ega. Murojaat info@med1.uz manziliga yuboriladi va 10 ish kunida ko'rib chiqiladi.
...
22.3. Korporativ mijozga xodimlar sog'lig'i to'g'risidagi individual tibbiy ma'lumotlar BERILMAYDI; faqat agregatlangan va shaxssizlantirilgan statistika taqdim etilishi mumkin.

22.4. Sug'urta tashkilotlari bilan integratsiya (DMS/ixtiyoriy tibbiy sug'urta) doirasida Bemor ma'lumotlari faqat uning aniq roziligi va sug'urta shartnomasi doirasida uzatiladi.

22.5. Sug'urta qoplamasi hajmi, cheklovlar va rad etish asoslari sug'urtalovchi tomonidan belgilanadi; Operator sug'urta to'lovi uchun javobgar emas.

22.6. Davlat organlari va byudjet muassasalari bilan munosabatlar davlat xaridlari to'g'risidagi qonunchilikka muvofiq alohida shartnomalar asosida amalga oshiriladi.
...
23.2. Referal dasturida taqiqlanadi: spam tarqatish, soxta hisoblar yaratish, kontekst reklamada «MED1» brend so'zlaridan Operator roziligisiz foydalanish, chalg'ituvchi va'dalar berish, tibbiy natijani kafolatlash.

23.3. Qoidabuzarlik aniqlansa, olingan rag'batlar bekor qilinadi va zarar undirilishi mumkin.

23.4. Platformada reklama joylashtirish «Reklama to'g'risida»gi Qonunga muvofiq amalga oshiriladi. Dori vositalari va tibbiy xizmatlar reklamasi qonunchilikda belgilangan cheklovlarga bo'ysunadi.

23.5. Reklama beruvchi taqdim etgan materialning to'g'riligi, litsenziya va ruxsatnomalar mavjudligi uchun reklama beruvchi javobgar.
...
24.3. «Oila profili» funksiyasi orqali bir hisobga bir necha bemor (bolalar, keksa qarindoshlar) biriktirilishi mumkin. Vakil har bir biriktirilgan shaxsning yozma yoki elektron roziligiga ega bo'lishi shart (voyaga yetmaganlar bundan mustasno).

24.4. Voyaga yetgan shaxs istalgan vaqtda vakilning kirish huquqini bekor qilishi mumkin. 18 yoshga to'lganda bolaning profili avtomatik ravishda mustaqil hisobga o'tkazilishi taklif etiladi.

24.5. Nogironligi bo'lgan shaxslar uchun Platforma imkon qadar moslashtirilgan interfeys (shrift kattaligi, kontrast, skrinrider bilan moslik) taqdim etishga intiladi.
...
25.4. Zaiflikni sinash uchun real foydalanuvchilar ma'lumotlariga kirish, xizmatni buzish yoki ma'lumotlarni yuklab olish qat'iyan taqiqlanadi.

25.5. Operator hisobga shubhali kirish aniqlanganda seansni to'xtatish, parolni majburiy yangilash va qo'shimcha tekshiruv talab qilish huquqiga ega.

25.6. Foydalanuvchi fishing xabarlariga ehtiyot bo'lishi kerak: Operator hech qachon parol, karta CVV kodi yoki to'liq karta raqamini so'ramaydi.
...
26.4. Xalqaro sanksiya ro'yxatlariga kiritilgan shaxslarga xizmat ko'rsatish rad etiladi.
...
27.3. Kontenti olib tashlangan Foydalanuvchi 14 (o'n to'rt) kun ichida apellyatsiya berishi mumkin. Apellyatsiya boshqa mas'ul xodim tomonidan ko'rib chiqiladi.

27.4. Hisob bloklanganda Foydalanuvchi blokirovka sababi to'g'risida xabardor qilinadi, agar bu tergov manfaatlariga yoki qonun talablariga zid bo'lmasa.

27.5. Asossiz yoki soxta shikoyat berish, moderatsiya tizimini raqobat maqsadida suiiste'mol qilish taqiqlanadi va javobgarlikka sabab bo'ladi.
...
28.2. Shartnomaning ajralmas qismlari: Maxfiylik siyosati; Kukilar siyosati; Tariflar; Medical Disclaimer; Teletibbiyot roziligi; SaaS shartlari; API shartlari; Med-Coin qoidalari; Sharh qoldirish qoidalari; Ilova №1–№4.

28.3. Foydalanuvchi o'z huquq va majburiyatlarini uchinchi shaxsga Operatorning yozma roziligisiz o'tkaza olmaydi. Operator qayta tashkil etish yoki biznesni o'tkazish holatlarida huquqlarni o'tkazishga haqli.

28.4. Operatorning biror huquqni qo'llamasligi undan voz kechish deb hisoblanmaydi.

28.5. Shartnoma tomonlar o'rtasida to'liq kelishuvni tashkil etadi va oldingi og'zaki kelishuvlarni bekor qiladi.

28.6. Shartnoma tomonlar o'rtasida shirkat, birgalikdagi faoliyat, mehnat yoki agentlik munosabatlarini vujudga keltirmaydi, agar alohida shartnomada aksi ko'rsatilmagan bo'lsa.

28.7. Ushbu Shartnoma elektron shaklda tuzilgan bo'lib, «Elektron hujjat aylanishi to'g'risida»gi Qonunga muvofiq qog'ozdagi shartnoma bilan teng yuridik kuchga ega.

28.8. Shartnomaning amaldagi tahriri doimo med1.uz saytida ochiq mavjud bo'ladi.
...
☐ Foydalanuvchi shartnomasi (ommaviy oferta) shartlarini to'liq o'qib chiqdim, tushundim va qabul qilaman.

☐ Maxfiylik siyosati va Kukilar siyosati bilan tanishdim.

☐ Shaxsiy ma'lumotlarim qayta ishlanishiga rozilik beraman.

☐ SOG'LIG'IM TO'G'RISIDAGI maxsus toifadagi ma'lumotlar qayta ishlanishiga alohida rozilik beraman.

☐ Teletibbiyot xizmatlarining tabiati va cheklovlari tushuntirildi; masofaviy konsultatsiyaga roziman.

☐ AI-modullar natijalari tibbiy tashxis emasligini tushunaman.

☐ Xizmatga oid (tranzaksion) bildirishnomalarni olishga roziman.

☐ (Ixtiyoriy) Marketing va aksiya xabarlarini olishga roziman.
...
| AI-modullar | Bemor, Shifokor | Freemium / obuna |
| EMR arxivi | Bemor, Klinika | Bepul (bazaviy) / kengaytirilgan obuna |
| Laboratoriya buyurtmasi | Bemor | Laboratoriya narxi + komissiya |
| SaaS-panel (CRM) | Klinika, Shifokor | Oylik/yillik obuna |
| API integratsiya | Hamkor | Obuna / so'rovlar hajmi bo'yicha |
...
| To'lov | Tranzaksiya ID, summa, maskalangan karta | 5 yil (buxgalteriya talabi) |
| Texnik | IP, qurilma, brauzer, cookie, loglar | 12 oy |
