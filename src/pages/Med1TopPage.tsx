  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* Tariffs & creative guide live on their own page */}
        <section className="container mx-auto px-4 pb-2">
          <div className="rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-4 flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="font-heading font-bold text-foreground">Tariflar va kreativ qo'llanma</p>
              <p className="text-sm text-muted-foreground">
                O'rinlar narxi, 24 tibbiy yo'nalish bo'yicha talab va e'lon tayyorlash qoidalari — alohida sahifada.
              </p>
            </div>
            <Button asChild variant="outline">
              <Link to="/med1-top/guide" target="_blank" rel="noopener">
                Ochish <ExternalLink className="w-4 h-4 ml-1" />
              </Link>
            </Button>
          </div>
        </section>
