...
const medicalTerms: Record<string, { term: string; desc: string }[]> = {
  A: [
    { term: "Allergiya", desc: "Immunitet tizimining ortiqcha reaktsiyasi" },
    { term: "Anesteziologiya", desc: "Og'riqsizlantirish fani" },
    { term: "Antibiotiklar", desc: "Bakteriyalarga qarshi dori vositalari" },
    { term: "Antioksidantlar", desc: "Erkin radikallarga qarshi moddalar" },
    { term: "Aritmiya", desc: "Yurak ritmining buzilishi" },
    { term: "Anatomiya", desc: "Tana tuzilishini o'rganuvchi fan" },
    { term: "Anemiya", desc: "Qonda gemoglobin kamayishi" },
    { term: "Artrit", desc: "Bo'g'imlar yallig'lanishi" },
  ],
  B: [
    { term: "Bakteriya", desc: "Bir hujayrali mikroorganizmlar" },
    { term: "Bioximiya", desc: "Tirik organizmlar kimyosi" },
    { term: "Bronxit", desc: "Bronxlar yallig'lanishi" },
    { term: "Buyrak kasalliklari", desc: "Buyrak funksiyasi buzilishi" },
    { term: "Bradikardiya", desc: "Yurak urishining sekinlashishi" },
    { term: "Biopsiуа", desc: "To'qima namunasi olish tekshiruvi" },
  ],
  C: [
    { term: "CT (kompyuter tomografiya)", desc: "Rentgen nurlar yordamida tasvirlash" },
    { term: "Цistit", desc: "Siydik pufagi yallig'lanishi" },
  ],
  D: [
    { term: "Dermatologiya", desc: "Teri kasalliklari fani" },
    { term: "Diabet", desc: "Qandli diabet — insulin etishmovchiligi" },
    { term: "Diagnostika", desc: "Kasallikni aniqlash usullari" },
    { term: "Дisleksiya", desc: "O'qish qobiliyati buzilishi" },
    { term: "DNK", desc: "Dezoksiribonuklein kislota — irsiyat tashuvchi" },
  ],
  E: [
    { term: "Endokrinologiya", desc: "Ichki sekretsiya bezlari fani" },
    { term: "Epidemiya", desc: "Kasallikning keng tarqalishi" },
    { term: "Epilepsiya", desc: "Miya tutqanoq kasalligi" },
  ],
  F: [
    { term: "Farmakologiya", desc: "Dori vositalari haqidagi fan" },
    { term: "Fiziologiya", desc: "Tirik organizmlar funksiyalari" },
    { term: "Fibroz", desc: "Biriktiruvchi to'qima o'sishi" },
  ],
  G: [
    { term: "Gastroenterologiya", desc: "Oshqozon-ichak tizimi fani" },
    { term: "Genetika", desc: "Irsiyat va o'zgaruvchanlik fani" },
    { term: "Ginekologiya", desc: "Ayollar kasalliklari fani" },
  ],
};
...
const categories = [
  {
    ...
    title: "Nevrologiya",
    count: "2,400+",
    desc: "Nerv tizimi va miya kasalliklari",
    image: anatomyImg,
  },
  {
    icon: Heart,
    title: "Kardiologiya",
    count: "1,800+",
    desc: "Yurak va qon tomir tizimlari",
    image: researchImg,
  },
  {
    icon: Microscope,
    title: "Farmakologiya",
    count: "3,200+",
    desc: "Dori vositalari va ta'sirlari",
    image: pillsImg,
  },
  {
    icon: Dna,
    title: "Genetika",
    count: "1,500+",
    desc: "Irsiyat va genetik kasalliklar",
    image: anatomyImg,
  },
];
...
const MedicinePage = () => {
  ...
  const currentTerms = medicalTerms[activeLetter] || [];
        ...
        <div className="relative container mx-auto px-4 py-20 md:py-28">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
              Tibbiy{" "}
              <span className="text-gradient">Entsiklopediya</span>
            </h1>
            ...
            <div className="relative max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: "0.25s" }}>
              <div className="flex items-center bg-card/95 backdrop-blur-sm rounded-2xl shadow-hero p-1.5">
                ...
                <input
                  type="text"
                  placeholder="20,000+ tibbiy atamalar ichidan qidiring..."
                  value={searchQuery}
                    ...
                    {medicalQuotes.map((_, i) => (
                      <button
                        ...
                        className={`w-3 h-3 rounded-full transition-all ${
                          i === activeQuote ? "bg-primary w-8" : "bg-border hover:bg-muted-foreground"
                        }`}
                      />
                    ))}
                  </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-hero-gradient flex items-center justify-center">
                  <span className="font-heading font-bold text-primary-foreground text-xl">{activeLetter}</span>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {filteredTerms.length} ta natija topildi
                  </p>
                </div>
              </div>
            </div>
            ...
            {filteredTerms.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  "{activeLetter}" harfi bo'yicha atamalar hozircha yuklanmoqda...
                </p>
              </div>
            )}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  "Buyraklar kuniga 180 litr qonni filtrлaydi",
                ].map((fact, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 p-4 bg-card rounded-xl border border-border shadow-card animate-fade-up"
                    style={{ animationDelay: `${i * 0.1}s` }}
                  >
            ...
            <div className="relative">
              <img
                src={anatomyImg}
                alt="Inson anatomiyasi"
                className="rounded-3xl shadow-hero w-full"
              />
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-t from-medical-navy/60 to-transparent" />
              <div className="absolute bottom-6 left-6 right-6">
                <p className="font-heading text-primary-foreground font-semibold text-lg">
                  "Inson tanasi — eng mukammal laboratoriya"
                </p>
