...
import { Shield, CheckCircle, XCircle, FileText, Calendar, Globe, Loader2, User, Search } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-12 max-w-2xl">
        <div className="text-center mb-8">
          <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 ${
            loading ? "bg-muted" : searched && isValid ? "bg-primary/10" : searched ? "bg-destructive/10" : "bg-muted"
          }`}>
        ...
        <Card className="mb-6">
          <CardContent className="p-4">
            <p className="text-sm font-medium text-foreground mb-2">Hujjat ID kodini kiriting:</p>
        ...
        {loading ? (
          ...
          <Card className="border-destructive/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Ushbu verifikatsiya kodi bo'yicha hujjat topilmadi: <span className="font-mono">{manualCode}</span>
              </p>
            </CardContent>
          </Card>
        ) : null}
