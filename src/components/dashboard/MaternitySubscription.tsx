  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Tug'ruqxonangiz uchun mos tarifni tanlang va platformadan to'liq foydalaning
      </p>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                plan.is_popular
                  ? "border-pink-500 shadow-lg shadow-pink-500/10 relative"
                  : "border-border shadow-card"
              )}
            >
              {plan.is_popular && (
                <div className="absolute -top-2.5 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center gap-1 bg-gradient-to-r from-pink-500 to-pink-700 text-white text-[10px] font-bold px-3 py-1 rounded-full">
              ...
              <div className="mb-4">
                {Number(plan.price_monthly) > 0 ? (
                  ...
                  <span className="text-xl font-bold text-pink-500">Bepul</span>
                )}
              </div>
              ...
              <Button asChild size="sm" className={cn("w-full", plan.is_popular && "bg-gradient-to-r from-pink-500 to-pink-700 border-0")} variant={plan.is_popular ? "default" : "outline"}>
                <Link to="/pricing">
