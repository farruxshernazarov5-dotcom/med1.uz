          ...
          <div className="max-w-2xl">
            ...
            <div className="relative max-w-xl animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <button
                ...
                className="w-full flex items-center bg-card/95 backdrop-blur-sm rounded-2xl shadow-hero p-1.5 cursor-text"
              >
                <Search className="w-5 h-5 text-muted-foreground ml-4" />
                <span className="flex-1 px-4 py-3 text-muted-foreground text-left font-body">
                  Kasallik, dori, klinika qidirish...
                </span>
                <Button className="bg-hero-gradient text-primary-foreground border-0 rounded-xl px-6 hover:opacity-90 pointer-events-none">
                  Qidirish
                </Button>
              </button>
            </div>
