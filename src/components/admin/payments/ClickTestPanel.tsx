...
const ClickTestPanel = () => {
  ...
  const activationText = [
    ...
    "   - Ushbu xizmat uchun my.click.uz/services/pay hosted checkout alohida faollashtirilganmi;",
    "   - Tashkilot rekvizitlari (STIR/INN, bank hisob raqami va shartnoma) tasdiqlanganmi;",
    "   - Prepare/Complete URL'lar va domen whitelist'ga qo'shilganmi;",
    "   - Production Service ID va Merchant ID aynan bitta tashkilotga tegishlimi.",
    "",
    "Hosted checkout Click callback yuborishidan oldin \"Yetkazib beruvchidan ma'lumot yetarli emas\" xatosini qaytarmoqda. Callback va TAS-IX proxy ishlamoqda; Click tomonda xizmat profili/hosted checkout aktivatsiyasini tekshirishingizni so'raymiz.",
    "",
