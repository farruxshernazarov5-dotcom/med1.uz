...
const FloatingAISearch = () => {
  ...
  useEffect(() => {
    ...
    const openFromDock = () => setIsOpen(true);
    window.addEventListener("med1:open-ai-search", openFromDock);
    return () => {
      document.removeEventListener("keydown", handler);
      window.removeEventListener("med1:open-ai-search", openFromDock);
    };
  }, []);
  ...
  return (
    <>
      {/* Tugmalar FloatingDock ichiga ko'chirildi — bu yerda faqat modal qoladi */}
