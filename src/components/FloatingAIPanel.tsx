...
import {
  ...
  UtensilsCrossed, Heart, Pill, Dumbbell, Activity,
} from "lucide-react";
...
const AI_SERVICES = [
  ...
  { icon: UtensilsCrossed, title: "AI Dietolog", href: "/ai-dietolog", desc: "Ovqatlanish rejasi" },
  { icon: Heart, title: "AI Psixolog", href: "/ai-psixolog", desc: "Ruhiy salomatlik" },
  { icon: Pill, title: "AI Farmatsevt", href: "/ai-farmatsevt", desc: "Dori maslahat" },
  { icon: Dumbbell, title: "AI Fitness", href: "/ai-fitness", desc: "Mashq dasturlari" },
  { icon: Activity, title: "AI Vital Signs", href: "/ai-vital-signs", desc: "Puls, bosim, SpO2" },
];
...
const FloatingAIPanel = () => {
  ...
  const isOnAIPage = [
    "/ai-services", "/symptom-checker", "/ai-doctor-chat", "/ai-report-analysis",
    "/ai-health-risk", "/ai-radiology", "/ai-health-assistant", "/ai-pregnancy",
    "/ai-baby-care", "/ai-cosmetology", "/ai-dietolog", "/ai-psixolog",
    "/ai-farmatsevt", "/ai-fitness", "/ai-vital-signs",
        ...
        <div className="fixed bottom-24 right-6 z-50 w-[320px] max-w-[calc(100vw-2rem)] bg-card rounded-2xl border border-border shadow-hero animate-fade-up overflow-hidden">
          <div className="bg-hero-gradient px-4 py-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-primary-foreground/70 text-[11px]">14 ta sun'iy intellekt xizmati</p>
            </div>
          </div>
